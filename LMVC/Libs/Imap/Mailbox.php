...
require_once('MailboxException.php');
class LMVC_Libs_Imap_Mailbox {
	...
	public function getMail($mId) {
		...
		$mail = new LMVC_Libs_Imap_IncomingMail();
		$mail->mId = $mId;
	...
	protected function initMailPart(LMVC_Libs_Imap_IncomingMail $mail, $partStruct, $partNum) {
