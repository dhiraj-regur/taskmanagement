<?php 
/*require_once 'isd_lib/Catz.php';
require_once 'isd_lib/Db.php';*/
/*śćźżąłóć*/
abstract class Isd_Abs {
	var $db;
	var $now;
	var $today;
	var $ans = array();
